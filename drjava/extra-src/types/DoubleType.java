...
public class DoubleType extends FloatingPointType {
  ...
  public <RetType> RetType apply(TypeVisitor<RetType> visitor) {
    return visitor.forDoubleType(this);
  }

  public void apply(TypeVisitor_void visitor) {
    visitor.forDoubleType(this);
  }
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      DoubleType casted = (DoubleType) obj;
      return true;
    }
  }
  ...
  public void walk(TreeWalker w) {
    if (w.visitNode(this, "DoubleType", 0)) {
      w.endNode(this, "DoubleType", 0);
    }
  }
