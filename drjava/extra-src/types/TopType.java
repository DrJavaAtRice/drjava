...
public class TopType extends ValidType {
  ...
  public <RetType> RetType apply(TypeVisitor<RetType> visitor) {
    return visitor.forTopType(this);
  }

  public void apply(TypeVisitor_void visitor) {
    visitor.forTopType(this);
  }
  ...
  public void walk(TreeWalker w) {
    if (w.visitNode(this, "TopType", 0)) {
      w.endNode(this, "TopType", 0);
    }
  }
