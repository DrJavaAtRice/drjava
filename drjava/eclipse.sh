...
${ECLIPSE}/plugins/org.eclipse.core.boot_${ECLIPSE_VERSION_OLD}/boot.jar${SEP}\
...
${ECLIPSE}/plugins/org.eclipse.ui.console_${ECLIPSE_VERSION_OLD}/console.jar${SEP}\
...
${ECLIPSE}/plugins/org.eclipse.jface_${ECLIPSE_VERSION_OLD}/jface.jar${SEP}\
