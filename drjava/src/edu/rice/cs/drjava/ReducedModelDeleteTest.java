...
public class ReducedModelDeleteTest extends TestCase {
  ...
  public void testDeleteBlockCommentMakesLineComment() {
    ...
    assertEquals("#2.1", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    model1.insertChar('*');
    assertEquals("#3.0", 5, model1.absOffset());
    assertEquals("#3.1", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    model1.insertChar('/');
    ...
    assertEquals("#5.1", ReducedToken.FREE, model1.getStateAtCurrent());
    //  /*__*/_#
    model1.move(-6);
    ...
    assertEquals("#7.3", ReducedToken.FREE, model1.getStateAtCurrent());
    model1.move(1);
    ...
    assertEquals("#7.3", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
  }
  ...
  public void testLineCommentStealsBlockCommentSlash() {
    ...
    assertEquals("#4.2", ReducedToken.FREE, model1.getStateAtCurrent());
    model1.move(1);
    assertEquals("#5.0", 2, model1.absOffset());
    assertEquals("#5.1", "*", model1.currentToken().getType());
    assertEquals("#5.2", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
    assertEquals("#5.3", ReducedToken.INSIDE_LINE_COMMENT, model1.currentToken().getState());
  }
  ...
  public void testDeleteNewlineAndShadowBlockCommentStart() {
    ...
    model1.insertChar('/');
    assertEquals("#1.0", 2, model1.absOffset());
    assertEquals("#1.1", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
    model1.insertChar('*');
    ...
    assertEquals("#3.1", ReducedToken.FREE, model1.getStateAtCurrent());
    model1.insertChar('/');
    ...
    assertEquals("#7.1", "/", model1.currentToken().getType());
    assertEquals("#7.2", ReducedToken.INSIDE_LINE_COMMENT, model1.currentToken().getState());
    model1.move(-1);
    assertEquals("#8.0", 2, model1.absOffset());
    assertEquals("#8.1", "*", model1.currentToken().getType());
    assertEquals("#8.2", ReducedToken.INSIDE_LINE_COMMENT, model1.currentToken().getState());
    model1.move(2);
    assertEquals("#9.0", 4, model1.absOffset());
    assertEquals("#9.1", "*", model1.currentToken().getType());
    assertEquals("#9.2", ReducedToken.INSIDE_LINE_COMMENT, model1.currentToken().getState());
  }
  ...
  public void testBlockCommentStartEatsEnd() {
    ...
    assertEquals("#6.2", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    assertEquals("#6.3", ReducedToken.INSIDE_BLOCK_COMMENT, model1.currentToken().getState());
    model1.move(1);
    assertEquals("#7.0", 3, model1.absOffset());
    assertEquals("#7.1", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
  }
  ...
  public void deleteLineCommentSlashOpensBlockComment() {
    ...
    assertEquals("#1.1", ReducedToken.FREE, model1.getStateAtCurrent());
    assertEquals("#1.2", "/", model1.currentToken().getType());
    model1.move(-1);
    assertEquals("#2.0", 7, model1.absOffset());
    assertEquals("#2.1", ReducedToken.FREE, model1.getStateAtCurrent());
    assertEquals("#2.2", "*", model1.currentToken().getType());
    model1.move(-1);
    ...
    assertEquals("#5.1", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
    assertEquals("#5.2", "\n", model1.currentToken().getType());
    model1.move(-1);
    assertEquals("#6.0", 2, model1.absOffset());
    assertEquals("#6.1", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
    assertEquals("#6.2", "*", model1.currentToken().getType());
    model1.move(-1);
    assertEquals("#7.0", 1, model1.absOffset());
    assertEquals("#7.1", ReducedToken.FREE, model1.getStateAtCurrent());
    assertEquals("#7.2", "//", model1.currentToken().getType());
    model1.delete(-1);
    assertEquals("#8.0", 0, model1.absOffset());
    assertEquals("#8.1", ReducedToken.FREE, model1.getStateAtCurrent());
    assertEquals("#8.2", "/*", model1.currentToken().getType());
    model1.move(7);
    assertEquals("#8.0", 7, model1.absOffset());
    assertEquals("#8.1", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    assertEquals("#8.2", "*/", model1.currentToken().getType());
  }
  ...
  public void testStartDeleteGap() {
    ...
    assertEquals("#0.2", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    model1.move(-2);
    assertEquals("#1.0", 0, model1.absOffset());
    assertEquals("#1.1", "/*", model1.currentToken().getType());
    assertEquals("#1.2", ReducedToken.FREE, model1.getStateAtCurrent());
  }
  ...
  public void testDeleteFreesBlockCommentEnd() {
    ...
    assertEquals("#1.3", ReducedToken.FREE, model1.getStateAtCurrent());
  }
  ...
  public void testUnmaskBlockCommentedLineComment() {
    ...
    assertEquals("#0.1", "/", model1.currentToken().getType());
    assertEquals("#0.2", ReducedToken.INSIDE_BLOCK_COMMENT, model1.currentToken().getState());
    assertEquals("#0.3", ReducedToken.INSIDE_BLOCK_COMMENT, model1.getStateAtCurrent());
    model1.move(-1);
    ...
    assertEquals("#2.3", ReducedToken.FREE, model1.getStateAtCurrent());
    model1.move(2);
  ...
  public void testCrazyDelete() {
    ...
    model1.insertChar('/');
    assertEquals("#0.0", 8, model1.absOffset());
    assertEquals("#0.1", ReducedToken.INSIDE_LINE_COMMENT, model1.getStateAtCurrent());
    model1.move(-2);
    assertEquals("#1.0", 6, model1.absOffset());
    assertEquals("#1.1", ReducedToken.FREE, model1.getStateAtCurrent());
    assertEquals("#1.2", "//", model1.currentToken().getType());
    ...
    assertEquals("#2.1", "/", model1.currentToken().getType());
    assertEquals("#2.2", ReducedToken.INSIDE_LINE_COMMENT, model1.currentToken().getState());
    model1.move(1);
