	...
	public void testInsideQuotePrevious()
		{
			...
			assertEquals("#1.1", ReducedToken.FREE,
									 model1.getCursor().prevItem().getState());
			assertTrue("#1.2", model1.getCursor().prevItem().isClosed());
	...
	public void testInsideQuoteNext()
		{
			...
			assertEquals("#4.1", ReducedToken.FREE,
									 model1.getCursor().prevItem().getState());
			assertTrue("#4.2", model1.getCursor().prevItem().isClosed());
	...
	public void testBackSlashBeforeDoubleEscape()
		{
			...
			model2.move(-2);
			model2.insertBackSlash();
			assertEquals("#1.0", "\\\\", model2.getCursor().current().getType());
			assertEquals("#1.1", 1, model2.getBlockOffset());
			assertEquals("#1.2", "\"", model2.getCursor().nextItem().getType());
	...
	public void testInsertBetweenDoubleEscape()
		{
			...
			model2.move(-1);
			model2.insertBackSlash();
			assertEquals("#1.0", "\\\\", model2.getCursor().prevItem().getType());
			assertEquals("#1.1", "\"", model2.getCursor().current().getType());
			...
			model0.move(-1);
			assertEquals("#2.0", "\\", model0.getCursor().prevItem().getType());
			assertEquals("#2.1", ")", model0.getCursor().current().getType());
			assertEquals("#2.2", "\\", model0.getCursor().nextItem().getType());
			...
			model0.insertClosedParen();
			model0.move(-1);
			assertEquals("#3.0", "\\", model0.getCursor().prevItem().getType());
			assertEquals("#3.1", ")", model0.getCursor().current().getType());
			assertEquals("#3.2", "\"", model0.getCursor().nextItem().getType());
		}
	...
	public void testDeleteAndCombine()
		{
			...
			model0.insertQuote();
			model0.move(-1);
			assertEquals("#0.0", "\"", model0.getCursor().current().getType());
			model0.delete(-2);
			assertEquals("#1.0", "\\\"", model0.getCursor().current().getType());
			assertEquals("#1.1", 1, model0.getBlockOffset());

			model0.delete(1);
			model0.insertGap(2);
			model0.insertBackSlash();
			model0.move(-1);
			assertEquals("#2.0", "\\", model0.getCursor().current().getType());
			model0.delete(-2);
			assertEquals("#3.0", "\\\\", model0.getCursor().current().getType());
			assertEquals("#3.1", 1, model0.getBlockOffset());
		}
	...
	public void testDeleteAndCombine2()
		{
			...
			model0.delete(-1);
			model0.move(1);
			assertEquals("#0.0", "\"", model0.getCursor().prevItem().getType());
			assertEquals("#0.1", ReducedToken.INSIDE_QUOTE,
	...
	public void testDeleteAndCombine3()
		{
			...
			model0.delete(-4);
			assertEquals("#0.0", "\\\\", model0.getCursor().current().getType());
			assertEquals("#0.1", 1, model0.getBlockOffset());
	...
	public void testChainEffect()
		{
			...
			// "\"""\"""\""#
			assertEquals("#0.0", "\"", model0.getCursor().prevItem().getType());
			assertTrue("#0.1", model0.getCursor().prevItem().isClosed());
			...
			assertEquals("#1.2", "\"", model0.getCursor().prevItem().getType());
			assertEquals("#1.3", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());
			assertTrue("#1.4", model0.getCursor().prevItem().isOpen());
			...
			assertEquals("#2.1", ReducedToken.INSIDE_QUOTE,
									 model0.getCursor().current().getState());
			assertEquals("#2.2", 1, model0.getBlockOffset());
			assertEquals("#2.3", "\"", model0.getCursor().prevItem().getType());
			assertEquals("#2.4", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());
			assertTrue("#2.5", model0.getCursor().prevItem().isOpen());
			assertEquals("#2.6", "\"", model0.getCursor().nextItem().getType());
			assertEquals("#2.7", ReducedToken.FREE,
									 model0.getCursor().nextItem().getState());
			assertTrue("#2.8", model0.getCursor().nextItem().isClosed());
			...
			assertEquals("#3.1", ReducedToken.INSIDE_QUOTE,
									 model0.getCursor().current().getState());
			assertEquals("#3.2", 0, model0.getBlockOffset());
			assertEquals("#3.3", "\\\"", model0.getCursor().prevItem().getType());
			assertEquals("#3.4", ReducedToken.INSIDE_QUOTE,
									 model0.getCursor().prevItem().getState());
			assertEquals("#3.5", "\"", model0.getCursor().nextItem().getType());
			assertEquals("#3.6", ReducedToken.FREE,
									 model0.getCursor().nextItem().getState());
			assertTrue("#3.7", model0.getCursor().nextItem().isClosed());

			model0.move(-10);
			// "#\"""\"""\"\""
			model0.delete(1);
			// "#"""\"""\"\""
			assertEquals("#4.0", "\"", model0.getCursor().prevItem().getType());
			assertTrue("#4.1", model0.getCursor().prevItem().isOpen());
			assertEquals("#4.2", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());									 
			assertEquals("#4.3", "\"", model0.getCursor().current().getType());
			assertTrue("#4.4", model0.getCursor().current().isClosed());
			assertEquals("#4.5", ReducedToken.FREE,
									 model0.getCursor().current().getState());

			model0.move(2);
			// """#"\"""\"\""
			assertEquals("#5.0", "\"", model0.getCursor().prevItem().getType());
			assertTrue("#5.1", model0.getCursor().prevItem().isOpen());
			assertEquals("#5.2", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());									 
			assertEquals("#5.3", "\"", model0.getCursor().current().getType());
			assertTrue("#5.4", model0.getCursor().current().isClosed());
			assertEquals("#5.5", ReducedToken.FREE,
									 model0.getCursor().current().getState());
			assertEquals("#5.6", "\\\"", model0.getCursor().nextItem().getType());
			assertEquals("#5.7", ReducedToken.FREE,
									 model0.getCursor().nextItem().getState());
			
			model0.move(4);
			// """"\""#"\"\""
			assertEquals("#6.0", "\"", model0.getCursor().prevItem().getType());
			assertTrue("#6.1", model0.getCursor().prevItem().isOpen());
			assertEquals("#6.2", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());									 
			assertEquals("#6.3", "\"", model0.getCursor().current().getType());
			assertTrue("#6.4", model0.getCursor().current().isClosed());
			assertEquals("#6.5", ReducedToken.FREE,
									 model0.getCursor().current().getState());
			assertEquals("#6.6", "\\\"", model0.getCursor().nextItem().getType());
			...
			assertEquals("#6.1", ReducedToken.FREE,
									 model0.getCursor().prevItem().getState());									 
			assertEquals("#6.2", "\"", model0.getCursor().current().getType());
			assertTrue("#6.3", model0.getCursor().current().isOpen());
