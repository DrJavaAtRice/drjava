...
public class VectorOption<T> extends Option<Vector<T>> {  
    ...
    String header, char delim, String footer) {
 super(key); 
 this.parser = parser;
 ...
 this.footer = footer;
    ...
    public VectorOption(String key, Option<T> strategy, String header,
                        char delim, String footer) {
      this(key, strategy, strategy, header, delim, footer);
    }
     ...
     */
    public VectorOption(String key, Option<T> option) {
      this(key,option,option,"[",',',"]");
    }
