...
/**
 * Base class for tests over the {@link SingleDisplayModel}.
 *
 * This class provides a number of convenience methods for testing the
 * SingleDisplayModel. It also contains a model instance (reset in {@link #setUp}
 ...
 * @version $Id$
 */
public abstract class SingleDisplayModelTestCase extends TestCase {
   ...
   * @param  String name
   */
  public SingleDisplayModelTestCase(String name) {
    super(name);
  }
   ...
   * <OL>
   * <LI>
   *  Creates a new SingleDisplayModel in {@link #_model} for each test case run.
   * </LI>
   * <LI>
    ...
    throws BadLocationException
  {
    assertTrue("number of documents",
               _model.getDefinitionsDocuments().getSize() > 0);
  }
   ...
   */
  protected static class TestListener implements SingleDisplayModelListener {
