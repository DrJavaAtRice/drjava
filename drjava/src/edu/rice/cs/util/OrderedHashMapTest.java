...
public class OrderedHashMapTest extends TestCase {
  ...
  public void testSearch() {
    ...
    OrderedHashMap<Integer> iTod = new OrderedHashMap<Integer>();
  ...
  public void testRemove() {
    ...
    OrderedHashMap<Integer> dToi = new OrderedHashMap<Integer>();
  ...
  public void testPut() {
    ...
    OrderedHashMap<String> myhash = new OrderedHashMap<String>();
