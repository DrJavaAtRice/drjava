 ...
 * infinite recursion.  By checking that a given arguments have not used previously before
 ...
 * to explicity check for containment, {@link #push} the arguments, recur, and then 
