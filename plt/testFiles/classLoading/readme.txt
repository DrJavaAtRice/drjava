...
intbox/IntBox.java: An interface shared by all classes
a/A.java: A class that references IntBox
b/B.java: A class that references IntBox
c/C.java: A class that references A and IntBox
