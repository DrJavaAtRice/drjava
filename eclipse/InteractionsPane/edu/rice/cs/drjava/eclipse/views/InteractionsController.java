...
package edu.rice.cs.drjava.eclipse.views;
...
import edu.rice.cs.drjava.eclipse.DrJavaConstants;
import edu.rice.cs.drjava.eclipse.EclipsePlugin;
import edu.rice.cs.drjava.eclipse.repl.EclipseInteractionsModel;
import edu.rice.cs.drjava.eclipse.util.text.SWTDocumentAdapter;
import edu.rice.cs.drjava.eclipse.util.text.SWTDocumentAdapter.SWTStyle;
...
/** This class installs listeners and actions between an InteractionsDocument
  ...
  *
  * @version $Id: InteractionsController.java 4314 2008-01-30 00:08:33Z mgricken $
  */
    ...
    Action resetInteractionsAction = new Action() {
      public void run() {
        ...
        if (!_promptToReset || _view.showConfirmDialog(title, message)) {
          _model.resetInterpreter(FileOps.NULL_FILE);  // should we keep a working directory?
        }
      }
    };
