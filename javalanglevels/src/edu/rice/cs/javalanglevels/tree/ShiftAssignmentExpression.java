 ...
 */
public abstract class ShiftAssignmentExpression extends AssignmentExpression {

  /**
   * Constructs a ShiftAssignmentExpression.
   * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
   */
  public ShiftAssignmentExpression(SourceInfo in_sourceInfo, Expression in_name, Expression in_value) {
