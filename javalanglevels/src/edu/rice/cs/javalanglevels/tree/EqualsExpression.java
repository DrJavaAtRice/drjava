...
public class EqualsExpression extends EqualityExpression {
   ...
   */
  public EqualsExpression(SourceInfo in_sourceInfo, Expression in_left, Expression in_right) {
    super(in_sourceInfo, in_left, in_right);
  }


  public <RetType> RetType visit(JExpressionIFVisitor<RetType> visitor) { return visitor.forEqualsExpression(this); }
  public void visit(JExpressionIFVisitor_void visitor) { visitor.forEqualsExpression(this); }
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      EqualsExpression casted = (EqualsExpression) obj;
