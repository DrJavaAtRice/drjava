 ...
 */
public abstract class ShiftBinaryExpression extends BinaryExpression {

  /**
   * Constructs a ShiftBinaryExpression.
   * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
   */
  public ShiftBinaryExpression(SourceInfo in_sourceInfo, Expression in_left, Expression in_right) {
