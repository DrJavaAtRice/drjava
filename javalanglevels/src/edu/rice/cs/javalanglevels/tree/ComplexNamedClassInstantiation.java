 ...
 */
public class ComplexNamedClassInstantiation extends NamedClassInstantiation {
   ...
   */
  public ComplexNamedClassInstantiation(SourceInfo in_sourceInfo, Expression in_enclosing, Type in_type, ParenthesizedExpressionList in_arguments) {
    super(in_sourceInfo, in_type, in_arguments);

    if (in_enclosing == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'enclosing' to the ComplexNamedClassInstantiation constructor was null. This class may not have null field values.");
    }
  ...
  public <RetType> RetType visit(JExpressionIFVisitor<RetType> visitor) { return visitor.forComplexNamedClassInstantiation(this); }
  public void visit(JExpressionIFVisitor_void visitor) { visitor.forComplexNamedClassInstantiation(this); }
  ...
  public void outputHelp(TabPrintWriter writer) {
    writer.print("ComplexNamedClassInstantiation" + ":");
    writer.indent();
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      ComplexNamedClassInstantiation casted = (ComplexNamedClassInstantiation) obj;
