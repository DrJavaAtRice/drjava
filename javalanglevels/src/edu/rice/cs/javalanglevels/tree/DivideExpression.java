...
public class DivideExpression extends NumericBinaryExpression {
   ...
   */
  public DivideExpression(SourceInfo in_sourceInfo, Expression in_left, Expression in_right) {
    super(in_sourceInfo, in_left, in_right);
  }


  public <RetType> RetType visit(JExpressionIFVisitor<RetType> visitor) { return visitor.forDivideExpression(this); }
  public void visit(JExpressionIFVisitor_void visitor) { visitor.forDivideExpression(this); }
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      DivideExpression casted = (DivideExpression) obj;
