 ...
 */
public abstract class NumericAssignmentExpression extends AssignmentExpression {

  /**
   * Constructs a NumericAssignmentExpression.
   * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
   */
  public NumericAssignmentExpression(SourceInfo in_sourceInfo, Expression in_name, Expression in_value) {
