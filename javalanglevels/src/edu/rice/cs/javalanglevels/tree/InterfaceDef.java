...
public class InterfaceDef extends TypeDefBase {
   ...
   */
  public InterfaceDef(SourceInfo in_sourceInfo, ModifiersAndVisibility in_mav, Word in_name, TypeParameter[] in_typeParameters, ReferenceType[] in_interfaces, BracedBody in_body) {
    super(in_sourceInfo, in_mav, in_name, in_typeParameters, in_interfaces, in_body);
  }


  public <RetType> RetType visit(JExpressionIFVisitor<RetType> visitor) { return visitor.forInterfaceDef(this); }
  public void visit(JExpressionIFVisitor_void visitor) { visitor.forInterfaceDef(this); }
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      InterfaceDef casted = (InterfaceDef) obj;
