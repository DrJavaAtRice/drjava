...
public class ConcreteMethodDef extends MethodDef {
   ...
   */
  public ConcreteMethodDef(SourceInfo in_sourceInfo, ModifiersAndVisibility in_mav, TypeParameter[] in_typeParams, ReturnTypeI in_result, Word in_name, FormalParameter[] in_params, ReferenceType[] in_throws, BracedBody in_body) {
    super(in_sourceInfo, in_mav, in_typeParams, in_result, in_name, in_params, in_throws);

    if (in_body == null) {
      throw new java.lang.IllegalArgumentException("Parameter 'body' to the ConcreteMethodDef constructor was null. This class may not have null field values.");
    }
    _body = in_body;
  }

  final public BracedBody getBody() { return _body; }

  public <RetType> RetType visit(JExpressionIFVisitor<RetType> visitor) { return visitor.forConcreteMethodDef(this); }
  public void visit(JExpressionIFVisitor_void visitor) { visitor.forConcreteMethodDef(this); }
  ...
  public void outputHelp(TabPrintWriter writer) {
    writer.print("ConcreteMethodDef" + ":");
    writer.indent();
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
      ...
      ConcreteMethodDef casted = (ConcreteMethodDef) obj;
