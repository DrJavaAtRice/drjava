 ...
 * @author  Stephane Hillion, adapted by Moez Abdel-Gawad
 * @version 1.1 - 1999/10/25, 1.5 - 2004/03/25
 */
...
public class Parser implements ParserConstants {
  ...
  final public PackageDeclaration packageDeclaration() throws ParseException {
    List<IdentifierToken> list = null;
    Token t1, t2;
   ...
   * @see koala.dynamicjava.parser.wrapper.TreeToken
   */
  final public List<List<IdentifierToken>> nameList() throws ParseException {
    List<List<IdentifierToken>> list = new LinkedList<List<IdentifierToken>>();
    List<IdentifierToken> obj;
    obj = name();
      list.add(obj);
    label_5:
    while (true) {
  ...
  final public MethodDeclaration methodDeclaration() throws ParseException {
    ...
    List<List<IdentifierToken>> exceptions = new LinkedList<List<IdentifierToken>>();
    Node              body = null;
    mf = modifiers();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LESS:
  ...
  final public Allocation simpleAllocationExpression() throws ParseException {
    ...
    default:
      ...
      IdentifierToken f  = ls.get(0);
      IdentifierToken l  = ls.get(ls.size()-1);
      ReferenceType rt;
      if(typeArgs == null){
        ...
        rt = new GenericReferenceType(ls,
                                      filename,
                                      f.beginLine(), f.beginColumn(),
                                      l.endLine(), l.endColumn(),
                                      typeArgs);
    ...
    if (jj_2_28(2)) {
      ...
      case NEW:
       ...
       if( typeArgs == null ){
         ...
         pt = new GenericReferenceType(ls,
                                       filename,
                                       f.beginLine(), f.beginColumn(),
                                       l.endLine(), l.endColumn(),
                                       typeArgs);
  ...
  final public Type type() throws ParseException {
    ...
    while (true) {
      ...
      if (pt != null) {
        ...
        IdentifierToken l  = ls.get(ls.size()-1);
        if(typeArgs == null){
          if(TypeParamsMap.containsKey(TreeUtilities.listToName(ls))){
            rt = TypeParamsMap.get(TreeUtilities.listToName(ls));
          } else if(GenericTypesEnv.contains(TreeUtilities.listToName(ls))){
            rt = GenericTypesEnv.lookup(TreeUtilities.listToName(ls));
          } else {
            rt = new ReferenceType(ls,
                                   filename,
                                   f.beginLine(), f.beginColumn(),
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x66b3c000,0x0,0x40204000,0x26938000,0x0,0x0,0x40204000,0x40204000,0x0,0x0,0x40004000,0x0,0x40004000,0x40004000,0x0,0x10000000,0x0,0x4432c000,0x4412c000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x44128000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x66b38000,0x24128000,0x0,0x10000000,0x4432c000,0x4412c000,0x24128000,0x0,0x24128000,0x66b38000,0x26b38000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x26938000,0x8000000,0x1040000,0x1040000,0x66b38000,0x64128000,0x24128000,0x24128000,0x24128000,0x0,0x0,0x0,0x24128000,0x80000,0x80000000,0x0,0x0,0x24128000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x24128000,0x0,0x24128000,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x24128000,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4128000,0x0,0x4128000,0x4128000,0x20000000,0x0,0x4128000,0x0,0x4128000,0x4128000,0x20000000,0x24128000,0x0,0x24128000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0