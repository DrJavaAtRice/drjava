...
//  
  ...
  final public FormalParameter formalParameter() throws ParseException {
    ...
    default:
      ...
      {if (true) return new FormalParameter(f != null, typ, id.image, varargs != null,
                                 filename,
